    ...
    <div class="container">
        <div class="row">
            <div class="col-sm|md|lg|xl|xxl-12 articles center" id="site-content">
                ...
                <form class="form-horizontal" role="form" method="post" action="{{ url($data->id, []) }}">
                    @method('patch')
                    @csrf
                    <div class="form-group form-group-lg">
                        <label class="col-sm-2 control-label" for="lg">Nama Pelanggan</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="lg" name="nama" value="{{$data->nama}}">
                        </div>
                    </div>
                    <div class="form-group form-group-lg">
                        <label class="col-sm-2 control-label" for="lg">Blok Rumah</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="lg" name="blok" value="{{$data->blok}}">
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-sm-2 control-label" for="sm">ID Pelanggan</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="sm" name="id_pelanggan" value="{{$data->pelanggan_id}}">
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-sm-2 control-label" for="sm">ID Pembayaran</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="sm" name="id_pembayaran" value="{{$data->id}}">
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-sm-2 control-label" for="sm">Total Pembayaran</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="sm" name="total_bayar" value="{{$data->total_biaya}}">
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-sm-2 control-label" for="sm">Tanggal Pembayaran</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="date" id="sm" name="tanggal" value="{{$data->tanggal_pembayaran}}">
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-sm-2 control-label" for="sm">Meteran Awal</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="sm" name="meteran_awal" value="{{$data->meteran_awal}}">
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-sm-2 control-label" for="sm">Meteran Akhir</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="sm" name="meteran_akhir" value="{{$data->meteran_akhir}}">
                        </div>
                    </div>
