    ...
    <div class="container">
        <div class="row">
            <div class="col-sm|md|lg|xl|xxl-12 articles center" id="site-content">
                ...
                <a class="btn btn-primary" href="{{ url('/add') }}" id="data" >Tambah Data</a>
                <div class="mb-3">
                            ...
                            <tr>
                                ...
                                <td >
                                    <form action="" style="display: inline">
                                        <a href="{{ url($row->id)}}" type="button" class="btn btn-info">Edit</a>
                                    </form>
                                    <form action="{{ url('admin', $row->id)}}" style="display: inline" method="POST" onsubmit="return confirm('Yakin Hapus Data?')">
                                        @method('delete')
                                        @csrf
